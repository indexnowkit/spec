...
2. **P2, первым (5-й шаг), после публикации P1** — принято 2026-09-10 (спека 26 §9.5): спрос есть (1 111 загрузок/мес у конкурента),
   пакет — один–два дня поверх Django-адаптера.
